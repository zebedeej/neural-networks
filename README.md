### Tensor Reshaping and Neural Network Operations
The assignment uses TensorFlow and Python to demonstrate tensor operations, loss functions, neural network optimization, MNIST classification and TensorBoard logging.
